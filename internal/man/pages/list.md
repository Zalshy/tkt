...
| `--json` | bool | `false` | Output machine-readable JSON with tickets, filters, and pagination |
...
- `--json` outputs an object with `tickets`, `filters`, and `pagination` (`limit`, `all`, `has_more`) for scripts and LLM tools.
